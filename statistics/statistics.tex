...
\hypersetup{
            ...
            pdfauthor={Lead Author: Matthew J. C. Crump; Chapters 2 and 4 adapted from Navarro, D.; Videos: Jeffrey Suzuki},
            pdfborder={0 0 0},
            breaklinks=true}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/2happyPlot-1.pdf}
...
\includegraphics{statistics_files/figure-latex/2happyHist-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/2manyhistbin-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/2meanmodemed-1.pdf}
...
\includegraphics{statistics_files/figure-latex/unnamed-chunk-3-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3scatter1-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3posnegrand-1.pdf}
...
\includegraphics{statistics_files/figure-latex/3simsum-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3onethousandr-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3hsrdata-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3regression-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3regressionResiduals-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3minimizeSS-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3twolines-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3corwithLine-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3snakeplant-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3anotherthousand-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3reminder-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3histrandcor-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/3corrandN-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/4Unif-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/4unifmany-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/4samplestats-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/4sampledistmeannorm-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/4samplemeanunif-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/4samplemeanExp-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/4normalSDspercents-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/4normalSDspercentsB-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5unifagain-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5histunif-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5manysamples-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5whichone-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5unifsamp100-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5unifsamp1000-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5sampunifALOT-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5whichoneB-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5whichoneC-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5gumballA-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5gumballsims-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5gumballdiffs-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5manydiffs-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5histdiffgumball-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5crumptestdiff-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5crumpdecision-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5crumpuncertainty-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5crumpshade-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5sampleDistNormal-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5crumpminmax-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5crumpredline-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5randhist-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/5randquestion-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6sampleMSEM-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6thisexample-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6sampdists-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6tdecision-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6tnull-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6percentregions-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6critT-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6tonedirection-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6twotailedt-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6dft-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6flatp-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6flatp-2.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6simtsRep-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6simpsRep-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6simps1000-1.pdf}
\caption{\label{fig:6simps1000}1000 simulated ts from the null distribution}
\end{figure}

\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6simts1000-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6simtruets-1.pdf}
\caption{\label{fig:6simtruets}1000 ts when there is a true difference}
\end{figure}

\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6simtrueps-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6simtsB-1.pdf}
\caption{\label{fig:6simtsB}1000 ts for n =100, when there is a true effect}
\end{figure}

\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6simpsB-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6simtsC-1.pdf}
\caption{\label{fig:6simtsC}1000 ts for n =100, when there is a true effect}
\end{figure}

\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/6simpsC-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/7fnull-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/7criticalF-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/7manyDiffs-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/7manyDiffsBar-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/7flesshthanone-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/7sigdiffs-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/7tetrisData-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/8critcompare-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/8fpvaluedist-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/8pdistwithin-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/8behmcrump-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/9meandiff-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/9reward-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/9rewardB-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/9visualdiffs-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/9alleffects-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/9strp-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/10bar22-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/10lines22-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/10mainint-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/10mainintInc-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/1023design-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/1023one-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/1023int-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/10222-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/10222int-1.pdf}
...
\includegraphics{statistics_files/figure-latex/unnamed-chunk-93-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/12effectdists-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/12effectdistsB-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/12powercurve-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/12powercurveN-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/12effectsizeType1-1.pdf}
...
All ANOVAs discussed to date form \emph{linear models} --- as explicitly highlighted by R in the process of calling a linear model in the form of \VERB|\KeywordTok{aov}\NormalTok{( Y }\OperatorTok{~}\StringTok{ }\NormalTok{X1 }\OperatorTok{+}\StringTok{ }\NormalTok{X2 }\OperatorTok{+}\StringTok{ }\NormalTok{...)}|, which is `syntactic sugar' for \VERB|\KeywordTok{aov}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Y }\OperatorTok{~}\StringTok{ }\NormalTok{X1 }\OperatorTok{+}\StringTok{ }\NormalTok{X2 }\OperatorTok{+}\StringTok{ }\NormalTok{...))}|. The difference between the two largely are philosophical: with a change of naming and the interpetation of the model, we can make the same conclusions in a slightly different guise.
...
\]
where the \(\beta\)'s are unknown coefficients to be determined, and the \(\phi\)'s are (known) potentially non-linear functions of \(X\). Linear models are therefore called linear as they are \emph{linear in their parameters}, not (necessarily!) the independent variables.
...
\]
\emph{This} F-statistic tests the null hypothesis \(\beta=0\). It's \emph{exactly} the same as before.
...
y = \alpha + \beta_i
\]
where \(i\) identifies which category is the value of the predictor. If there are \(k\) categories, you'd get \(k-1\) degrees of freedom in the numerator in the F-statistic, and usually \(n-k\) degrees of freedom in the denominator. But the distinction between regression and analysis of variance is still the same for this kind of model. And that's, ultimately, why \VERB|\NormalTok{R}|'s help explicitly states that \VERB|\NormalTok{aov}| \emph{fits an analysis of variance model by a call to \texttt{lm} for each stratum}.

\hypertarget{mixed-models-a-mathematical-introduction}{%
\section{Mixed models -- a mathematical introduction}\label{mixed-models-a-mathematical-introduction}}

With that large introduction aside, linear mixed models are an extension to the above. Rather than having one error term, \(\epsilon_i\) which overall is normally distributed with zero mean and some (unknown) variance \(\sigma^2\), we relax this assumption. The \emph{mixed} bit is that instead of just including fixed effects -- corresponding to the fixed, common \(\beta\)'s above, we include additional random-effect terms, which are often appropriate for representing clustered, and therefore dependent, data. Examples include when data are collected hierarchically, when observations are taken on related individuals (such as siblings), or when data are gathered over time on the same individuals. The latter is particularly commonly performed in longitudinal experiments.

Like most areas of statistics, mixed models are a large and complex subject, and this set of notes is not intended to be definitive. The full mathematical expression for a general linear mixed model is mildly hairy, but the basic idea behind a random effect is that instead of having \emph{one true \(\beta\)} it is the case that \(\beta\) is itself a random variable. That is, say, \(\beta_1\sim N(\mu_{\beta_1}, \sigma_\beta_1)\). Were we to write this out in full, in the most general form, we'd end up with a moderately complicated set of equations:
...
\includegraphics{statistics_files/figure-latex/unnamed-chunk-127-1.pdf}
...
\begin{figure}
\centering
\includegraphics{statistics_files/figure-latex/unnamed-chunk-127-2.pdf}
...
These data have a twist: they're coloured by a grouping variable, and crucially the intercept for that random variable is correlated with \(x\). In a study context, this may well arise due to, for example, learning as some lurking variable. Rather irritatingly, the overall trend when data are summed therefore appears to be \emph{completely opposite} to that in each individual group. There's something else going on here, and the best way to quantify it is through mixed modelling. If we perform a conventional ANOVA on the linear model, we'd just call \VERB|\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(y }\OperatorTok{~}\StringTok{ }\NormalTok{x, simpson))}|; using the \VERB|\NormalTok{lm}| syntax directly:

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{OLS <-}\StringTok{ }\KeywordTok{lm}\NormalTok{(y }\OperatorTok{~}\StringTok{ }\NormalTok{x, simpson)}
\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(y }\OperatorTok{~}\StringTok{ }\NormalTok{x, simpson))}
\end{Highlighting}
\end{Shaded}
...
## F-statistic: 115.7 on 1 and 402 DF,  p-value: < 2.2e-16
\end{verbatim}

we see that the intercept and the coefficient for \(x\) are both highly different from zero, and the coefficient of \(x\) is positive -- as you might well expect. But, calling the same thing through a mixed model (with the \VERB|\NormalTok{lme4}| and \VERB|\NormalTok{lmerTest}| packages) yields a rather different answer. Here, we're saying that the \VERB|\NormalTok{Groups}| is our random effect, allowed to have a different intercept per group, but a common mean. If we wanted to relax \emph{that} assumption, we'd write \VERB|\NormalTok{(Groups}\OperatorTok{\VerbBar{}}\NormalTok{Groups)}|, but the resulting model would be very underdetermined and (in this case) not very informative. The use of the \VERB|\NormalTok{lmerTest}| is a convenience wrapper to provide \(p\)-values from mixed models; we can also call \VERB|\NormalTok{anova}| directly.
...
\includegraphics{statistics_files/figure-latex/unnamed-chunk-131-1.pdf}
